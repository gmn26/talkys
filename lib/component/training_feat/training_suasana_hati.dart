...
class TrainingSuasanaHatiComponent extends StatefulWidget {
  const TrainingSuasanaHatiComponent({super.key});

  @override
  _TrainingSuasanaHatiComponent createState() =>
      _TrainingSuasanaHatiComponent();
}

class _TrainingSuasanaHatiComponent extends State<TrainingSuasanaHatiComponent> {
